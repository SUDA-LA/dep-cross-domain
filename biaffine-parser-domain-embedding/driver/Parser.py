...
class BiaffineParser(object):
    ...
    def forward(self, words, extwords, tags, masks,tbank_ids):
        if self.use_cuda:
        ...
        arc_logits, rel_logits = self.model.forward(words, extwords, tags, masks,tbank_ids)
        # cache
    ...
    def parse(self, words, extwords, tags, lengths, masks,tbank_ids):
        if words is not None:
            self.forward(words, extwords, tags, masks,tbank_ids)
        ROOT = self.root
