...
class Configurable(object):
    ...
    @property
    def train_file2(self):
        return self._config.get('Data', 'train_file2')

    @property
    def train_file3(self):
        return self._config.get('Data', 'train_file3')
    ...
    @property
    def num_corpus_weighting1(self):
        return self._config.getint('Run', 'num_corpus_weighting1')

    @property
    def num_corpus_weighting2(self):
        return self._config.getint('Run', 'num_corpus_weighting2')

    @property
    def num_corpus_weighting3(self):
        return self._config.getint('Run', 'num_corpus_weighting3')
    ...
    @property
    def train_elmo(self):
        return self._config.get('Elmo', 'train_elmo')

    @property
    def dev_elmo(self):
        return self._config.get('Elmo', 'dev_elmo')

    @property
    def test_elmo(self):
        return self._config.get('Elmo', 'test_elmo')

    @property
    def elmo_dims(self):
        return self._config.getint('Elmo', 'elmo_dims')

    @property
    def tbank_emb_size(self):
        return self._config.getint('Treebankid', 'tbank_emb_size')

    @property
    def domain_num_corpus_weighting(self):
        return self._config.getint('corous-weighting', 'domain_num_corpus_weighting')

    @property
    def cw(self):
        return self._config.getint('corous-weighting', 'cw')

    @property
    def cdt_domain_ration(self):
        return self._config.getint('corous-weighting', 'cdt_domain_ration')

    @property
    def domain_data_size(self):
        return self._config.getint('corous-weighting', 'domain_data_size')
